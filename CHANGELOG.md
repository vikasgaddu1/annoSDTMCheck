...
### Added
- **Annotation Alignment Feature**: Automatically align annotations that are close to each other
  - Horizontal alignment: Aligns annotations with similar Y-coordinates (top edges)
  - Vertical alignment: Aligns annotations with similar X-coordinates (left edges)
  - Configurable tolerance (1-50 points) for both alignment types
  - Dry run mode to preview changes before applying
  - Integrated with standardization workflow
  - GUI controls in Configuration → Validation Settings
  - Standalone test script: `scripts/test_annotation_alignment.py`
  - Detailed statistics and reporting
  - Comprehensive documentation: `docs/ANNOTATION_ALIGNMENT.md`

### Changed
- Updated GUI Configuration tab with alignment controls:
  - Auto-Align Annotations checkbox (master switch)
  - Alignment type selection (Horizontal/Vertical)
  - Tolerance sliders for fine-tuning
  - Helpful tooltips and descriptions
- Enhanced standardization confirmation dialog to show alignment status
- Improved results dialog to display alignment statistics

### Technical
- New module: `src/sdtm_checker/core/annotation_aligner.py` - Core alignment functionality
- Updated: `src/sdtm_checker/core/annotation_standardizer.py` - Integrated alignment into workflow
- Updated: `src/sdtm_checker/gui/config_tab.py` - Added GUI controls
- Updated: `src/sdtm_checker/gui/main.py` - Updated result reporting
- New classes: `AnnotationAligner`, `AlignmentOperation`, `AlignmentStats`

### Use Cases
- Variable labels that should be horizontally aligned
- Form fields in tables
- Cleaning up manually-added annotations
- Creating professional-looking annotated CRFs
