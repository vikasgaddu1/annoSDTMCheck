...
- Extract and validate CRF annotations against SDTM datasets
- Support for multiple annotation patterns and formats
- Fuzzy matching for flexible validation
- Comprehensive Excel reports with detailed statistics

✅ **PDF Standardization**
- Standardize annotation colors (cyan backgrounds, black borders)
- Apply consistent formatting across all annotations
- Configurable author names and bookmark labels
- Dual hierarchical bookmark structure

✅ **Integrated Help System**
- **Press F1** for instant access to this User Guide in your browser
- **Quick Start Guide** for 5-minute setup
- **What's This?** mode (Shift+F1) for context-sensitive help
- All documentation opens as beautifully formatted HTML

✅ **User-Friendly Interface**
- Intuitive tab-based interface with tooltips
- Visual configuration management
- Real-time progress tracking
- Configuration save/load for multiple projects
...
The application includes a comprehensive Help menu for instant access to documentation:

#### Help Menu Options

1. **📖 User Guide (F1)**
   - Opens this complete user guide in your browser
   - Beautifully formatted HTML with professional styling
   - Fully searchable and print-friendly
   - **Shortcut**: Press **F1** anywhere in the application

2. **🚀 Quick Start Guide**
   - 5-minute setup guide for new users
   - Step-by-step configuration instructions
   - Common troubleshooting tips
   - **Access**: Help → Quick Start Guide

3. **❓ What's This? (Shift+F1)**
   - Context-sensitive help for any UI element
   - Click on buttons, fields, or tabs to see detailed help
   - Interactive help mode
   - **Shortcut**: Press **Shift+F1**, then click any element

4. **ℹ️ About**
   - Version information and feature summary
...
|----------|--------|
| **F1** | Open User Guide |
| **Shift+F1** | Enter What's This? mode |

#### Tooltips

Hover your mouse over any button, field, or setting to see helpful tooltips explaining:
- What the element does
- How to use it
- Examples and best practices
- Related settings

**Tip**: All documentation opens in your default web browser as professionally formatted HTML, so you don't need any special software to read it!
